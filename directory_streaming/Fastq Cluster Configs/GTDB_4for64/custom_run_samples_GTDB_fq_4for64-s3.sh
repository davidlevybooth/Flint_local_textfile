...
CONF_SAMPLES_JSON='/home/david/FLINT/Flint_UBC/directory_streaming/Fastq Cluster Configs/GTDB_4for64/custom_streaming_configuration-s3_GTDB_fq_output.json'
...
spark-submit    --master local \
                ...
                /home/david/FLINT/Flint_UBC/flint.py --samples '/home/david/FLINT/Flint_UBC/directory_streaming/Fastq Cluster Configs/GTDB_4for64/custom_streaming_configuration-s3_GTDB_fq_output.json' \
							   		    --output_local \
							   		    --verbose   \
										--sensitive \
										--coalesce_output \
